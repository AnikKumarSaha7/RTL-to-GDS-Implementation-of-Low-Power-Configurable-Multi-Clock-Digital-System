...
# Created by write_sdc on Sun Sep 28 22:08:47 2025

###################################################################
set sdc_version 2.0

set_units -time ns 
#-resistance kOhm -capacitance pF -voltage V -current mA
...
create_clock [get_ports REF_CLK]  -period 4  -waveform {0 2}
...
create_clock [get_ports UART_CLK]  -period 30  -waveform {0 15}
...
set_clock_transition -rise 0.1 [get_clocks UART_CLK]
#set_clock_transition -min -rise 0.05 [get_clocks UART_CLK]
set_clock_transition -fall 0.1 [get_clocks UART_CLK]
...
set_input_delay -clock UART_CLK  20  [get_ports UART_RX_IN]
set_output_delay -clock UART_TX_CLK  20  [get_ports UART_TX_O]
set_output_delay -clock UART_CLK  20  [get_ports parity_error]
set_output_delay -clock UART_CLK  20  [get_ports framing_error]
